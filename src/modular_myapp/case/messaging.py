...
通用 MQ connection、channel 和 producer 仍然由 myapp.mq 提供。
...
from modular_myapp.exceptions import MQQueueOverflowError
from modular_myapp.mq.deps import get_mq_producer
from modular_myapp.mq.exceptions import MQPublishRejectedError
from modular_myapp.mq.producer import MQProducer
from modular_myapp.mq.topology import MQQueueTopology

from .schemas import CaseCreatedMessage, CaseRead
