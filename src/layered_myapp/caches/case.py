...
通用 Redis 连接池和客户端仍然由 layered_myapp.redis 提供，这里只关心 case 模块自己的缓存规则。
...
from layered_myapp.redis.deps import get_redis_client
from layered_myapp.schemas.case import CaseRead
